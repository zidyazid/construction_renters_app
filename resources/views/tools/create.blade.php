    ...
    <h3 class="py-3">
        ...
        <form method="POST" action="{{ Route('tool.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group py-3">
              ...
              <input type="text" class="form-control" id="nama_alat" name="nama_alat" placeholder="Nama Alat Berat">
            </div>
            <div class="form-group py-3">
            ...
            <div class="form-group py-3">
              ...
              <input type="text" class="form-control" id="jumlah_ketersedian" name="jumlah_ketersedian" placeholder="Jumlah Unit">
            </div>
            {{-- <div class="form-group py-3">
              <label for="kondisi">Kondisi</label>
              <input type="text" class="form-control" id="kondisi" name="kondisi" placeholder="Kondisi">
